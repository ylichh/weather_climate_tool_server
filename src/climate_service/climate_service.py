...
class ClimateService(IClimateService):
    def __init__(self):
        self.repositorio_climas = {
            "parís": "Clima templado con estaciones marcadas. Veranos suaves y a veces cálidos. Otoños húmedos y frescos. Inviernos fríos con lluvias frecuentes.",
            "berlín": "Clima continental moderado. Veranos cálidos con algunos días muy calurosos. Otoños frescos y nublados. Inviernos fríos con heladas habituales.",
            ...
            "ámsterdam": "Clima oceánico. Veranos frescos y lluviosos. Otoños húmedos y ventosos. Inviernos fríos, raramente extremos.",
            ...
            "zúrich": "Clima continental alpino. Veranos cálidos. Otoños frescos y húmedos. Inviernos fríos con mucha probabilidad de nieve.",
            ...
            "dublín": "Clima oceánico húmedo. Veranos frescos. Otoños muy lluviosos. Inviernos fríos pero moderados.",
